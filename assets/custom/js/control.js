...
$(function() {
	...
	if (bookmark.is_started == false) {
		...
		// $('#module-content').css("background-image", "url(./assets/branding/slider.jpg)");
		// $('#module-content').css("background-repeat", "no-repeat");
		...
		if (pass) {
			...
			$('#module-assessment-review-btn').removeClass("hidden");
				...
				if(retryCount < 4){
					...
					$('#module-assessment-retry-btn').addClass("hidden");
					$('#module-assessment-retry-course-btn').addClass("hidden");
					$('#module-assessment-finish-btn').removeClass("hidden");
					$('#module-assessment-review-btn').removeClass("hidden");
				}
			$('#module-assessment-submit-btn').addClass("hidden");
